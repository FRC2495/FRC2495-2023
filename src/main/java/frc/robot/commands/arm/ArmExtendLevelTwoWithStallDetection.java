 ...
 *
 */
/*public*/ class ArmExtendLevelTwoWithStallDetection extends CommandBase {

	public ArmExtendLevelTwoWithStallDetection() {	
	...
	public void end(boolean interrupted) {
		System.out.println("ArmExtendLevelTwoWithStallDetection: end");
